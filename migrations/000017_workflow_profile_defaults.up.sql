ALTER TABLE workflow_profiles
    ...
    ADD COLUMN default_call_workflow_ids JSON NULL AFTER default_knowledge_mode,
    ADD COLUMN default_max_workflow_call_depth INT NOT NULL DEFAULT 3 AFTER default_call_workflow_ids;
