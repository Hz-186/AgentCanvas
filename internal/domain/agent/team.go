...
type Team struct {
	...
	SupervisorAgentID int64     `json:"supervisor_agent_id" gorm:"column:supervisor_agent_id"`
...
func (Team) TableName() string { return "agent_teams" }
...
func (TeamMember) TableName() string { return "agent_team_members" }
