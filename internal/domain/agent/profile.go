...
type Profile struct {
	...
	DefaultCallAgentIDs      json.RawMessage `json:"default_call_agent_ids" gorm:"column:default_call_agent_ids"`
	DefaultMaxAgentCallDepth int             `json:"default_max_agent_call_depth" gorm:"column:default_max_agent_call_depth"`
...
func (p *Profile) DefaultCallAgentIDsSlice() []int64 {
	return decodeInt64Slice(p.DefaultCallAgentIDs)
}
...
func (p *Profile) normalizeJSON() error {
	...
	p.DefaultCallAgentIDs = normalizeJSONField(p.DefaultCallAgentIDs)
