...
func (EvalDataset) TableName() string { return "agent_eval_datasets" }
...
func (EvalCase) TableName() string { return "agent_eval_cases" }
...
func (EvalRun) TableName() string { return "agent_eval_runs" }
...
type EvalResult struct {
	...
	AgentRunID   *int64          `json:"agent_run_id" gorm:"column:agent_run_id"`
	Status       string          `json:"status" gorm:"column:status"`
...
func (EvalResult) TableName() string { return "agent_eval_results" }
